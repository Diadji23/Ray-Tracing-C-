...
int main(){
    ...
    // Ici, la caméra est centrée sur l'axe x, à mi-hauteur de la boîte, et à une distance égale à 2 fois la taille de la boîte.
    ...
    Sphere sphere(Vector3f(6, 0.0f, 0.0f), 3.0f, Material(Vector3f(1.0f, 0.0f, 0.0f), 0.7f));
